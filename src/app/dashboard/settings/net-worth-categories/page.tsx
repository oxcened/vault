...
import { netWorthCategoryColumns } from "./config";
...
type TypeFilter = NetWorthCategoryType | "ALL";
...
export default function NetWorthCategoriesPage() {
  const { data, isPending } = api.netWorthCategory.getAll.useQuery();
  ...
  const table = useTable({
    data: filteredData,
    columns: netWorthCategoryColumns,
    getCoreRowModel: getCoreRowModel(),
    meta: {
      id: "netWorthCategories",
    },
  });
      ...
      <main className="mx-auto flex w-full max-w-screen-lg flex-col gap-5 p-5 md:py-8">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-muted-foreground">
            Organize assets and debts used to calculate your net worth.
          </p>
        </div>
            ...
            <div className="min-w-0 flex-1">
              ...
              >
                ...
                <SelectContent>
                  ...
                  {Object.values(NetWorthCategoryType).map((value) => (
