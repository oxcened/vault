...
const categoryIcons: Array<{
  ...
  },
  {
    ...
    config: { icon: House, className: "bg-blue-500/10 text-blue-500" },
  },
  {
    keywords: ["transport", "mobility", "car", "fuel"],
    config: { icon: BusFront, className: "bg-sky-500/10 text-sky-500" },
  },
  {
  ...
  },
  {
    ...
    config: { icon: Laptop, className: "bg-cyan-500/10 text-cyan-500" },
  },
  {
  ...
  },
  {
    ...
    config: { icon: CreditCard, className: "bg-slate-500/10 text-slate-500" },
  },
  {
    keywords: ["tax", "taxes", "contribution", "contributions"],
    config: { icon: Landmark, className: "bg-stone-500/10 text-stone-500" },
  },
  {
  ...
  },
  {
    ...
    config: { icon: KeyRound, className: "bg-yellow-500/10 text-yellow-500" },
  },
];
