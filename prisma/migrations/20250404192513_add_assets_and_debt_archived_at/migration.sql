-- AlterTable
ALTER TABLE "NetWorthAsset" ADD COLUMN     "archivedAt" TIMESTAMP(3);

-- AlterTable
ALTER TABLE "NetWorthDebt" ADD COLUMN     "archivedAt" TIMESTAMP(3);
...
BEGIN
  ...
  SELECT
    ...
    c."id" AS "categoryId",
    c."name" AS "categoryName",
    d."archivedAt" AS "debtArchivedAt"
  FROM "NetWorthDebt" d
