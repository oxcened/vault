-- AlterTable
ALTER TABLE "NetWorthAsset" ADD COLUMN     "poolInEnvelopes" BOOLEAN NOT NULL DEFAULT false;
...
-- AddForeignKey
ALTER TABLE "Envelope" ADD CONSTRAINT "Envelope_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
